	...
	$(document).ready(function(){
		...
		$("#employeesTbl").DataTable({
         ...
         //   "order"     : [[0, "desc"]],        // 기본 컬럼 정렬 설정  숫자 0은 첫번째 컬럼을 말하며, "asc" 또는 "desc"를 설정할 수 있다. 
            "order"     : [[2, "desc"],[0, "esc"]], // 기본 컬럼 정렬 설정  숫자 0은 첫번째 컬럼을 말하며, "asc" 또는 "desc"를 설정할 수 있다. 
            "stateSave" : false,
         //   "stateSave" : true, 
           /*
...
<body>
    ...
    <div style="width: 80%; margin: 0 auto;">
    	<table id="employeesTbl" style="width: 100%;" class="table table-bordered"><!-- 이거쓸땐 thead, tbody 태그 꼭 있어야함!!!! -->
    		<thead>
    			<tr>
    				<th>사원번호</th>
    				<th>사원명</th>
